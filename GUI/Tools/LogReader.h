...
class LogReader {
 public:
  ...
  int currentFrame; // Todo: This should be private.

  virtual const std::string getMaskPath() = 0;

  const int getCurrentFrameIndex() {return currentFrame;}

  virtual void setCurrentFrameIndex(unsigned int current_frame) = 0;
